                ...
                <div class="container-fluid" style="padding-left: 2vw; padding-right: 4vw;">
                  ...
                  <img src="images/editor4.png">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li>
                                     <a href="index.php">   <div class="d-grid gap-2">
                                            <button   type="button" class="btn" style="text-decoration: none; background-color: #EDEEF0;">
                                                Log out
                                            </button> 
                                        </div></a>
                                    </li>
                                    ...
                                    <li>
                                     <a href="sessionend.php">   <div class="d-grid gap-2">
                                            <button   type="button" class="btn" style="text-decoration: none; background-color: #EDEEF0;">
                                                Session End
                                            </button> 
                                        </div></a>
            ...
            <div class="container" style="padding:2vw;">
                    ...
                    <li class="nav-item">
                      ...
                      <li class="nav-item ms-auto">
                        <button style="background-color: #EDEEF0;color: black;border-color: white;"class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                          ...
                          &nbsp
                        <button type="button" class="btn" style="background-color: white; border-color: #989899;"><img src="logos/leave.png"> &nbspLeave Group</button>
                      </li>
                </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        ...
                        <div>
                            <p style="font-size: 14px;"> <img src="logos/like.png">&nbspRECOMMENDED GROUPS</p>
                            
        
                        <table>
                            <tbody>
                            <tr>
                            <td><img src="images/group1.png"></td>
                            <td  style="padding-top: 1vw; padding-left: 1vw;"><p style="font-size: 14px;">Leisure</p></td>
                            <td style="width: 4vw;"></td>
                            <td> <a data-toggle='collapse' href='#collapseExample' id='collapseExample1' style="border-radius: 2vw; background-color: #EDEEF0; color:black; font-size: 12px;" class='text-center btn btn-default' onclick="setColor('collapseExample1', '#101010')">Follow</a> </td>
                            </tr>
                            <tr>
                            <td><img src="images/group2.png"></td>
                            <td style="padding-top: 1vw; padding-left: 1vw;"><p style="font-size: 14px;">Activism</p></td>
                            <td></td>
                            <td><a data-toggle='collapse' href='#collapseExample' id='collapseExample2' style="border-radius: 2vw; background-color: #EDEEF0; color:black; font-size: 12px;" class='text-center btn btn-default' onclick="setColor('collapseExample2', '#101010')">Follow</a></td>
                            </tr>
                            <tr>
                            <td><img src="images/group3.png"></td>
                            <td style="padding-top: 1vw; padding-left: 1vw;"><p style="font-size: 14px;">MBA</p></td>
                            <td></td>
                            <td><a data-toggle='collapse' href='#collapseExample' id='collapseExample3' style="border-radius: 2vw; background-color: #EDEEF0; color:black; font-size: 12px;" class='text-center btn btn-default' onclick="setColor('collapseExample3', '#101010')">Follow</a></td>
                            </tr>
                            <tr>
                            <td><img src="images/group4.png"></td>
                            <td style="padding-top: 1vw; padding-left: 1vw;"><p style="font-size: 14px;">Philosophy</p></td>
                            <td></td>
                            <td><a data-toggle='collapse' href='#collapseExample' id='collapseExample4' style="border-radius: 2vw; background-color: #EDEEF0; color:black; font-size: 12px;" class='text-center btn btn-default' onclick="setColor('collapseExample4', '#101010')">Follow</a></td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <script>
                            ...
                            function setColor(btn, color) {
                                var property = document.getElementById(btn);
                                if (count == 0) {
                                    property.style.backgroundColor = "#EDEEF0"
                                    property.style.color = "#000000"
                                    count = 1;        
                                }
                                else {
